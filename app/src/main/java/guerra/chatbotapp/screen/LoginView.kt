...
fun LoginView(
    ...
    Scaffold(
        ...
        Column(
            ...
            Icon(
                modifier = Modifier.size(20.dp).padding(8.dp).clickable { },
            ...
            Column(
                ...
                Button(
                    ...
                    if (!isLoading)
                        Text(text = "Sign in", fontWeight = FontWeight.Bold, fontSize = 20.sp, color = MaterialTheme.colorScheme.onTertiary)
